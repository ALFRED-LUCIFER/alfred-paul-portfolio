...
const CodeSnippet = lazy(() =>
  import('./CodeSnippet').then((m) => ({ default: m.CodeSnippet }))
)
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-6">
                    <div className={`p-4 bg-linear-to-br ${service.color} rounded-2xl shadow-lg`}>
                  ...
                  <ul className="space-y-3">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center gap-3">
                        <div className={`w-2 h-2 bg-linear-to-r ${service.color} rounded-full shrink-0`} />
        ...
        >
          <div className="text-center mb-6">
            ...
            <h3 className="text-xl font-bold mt-2">
              AI Chatbot I Built — <span className="text-gradient">Qwen + RAG Pipeline</span>
            </h3>
          </div>
