...
const About = () => {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: "12+ years of proven expertise in .NET, Python, React, and cloud technologies with measurable results"
    },
    {
      icon: Target,
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                {/* Background Elements */}
                <div className="absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl rotate-6" />
                <div className="absolute inset-0 bg-linear-to-br from-primary/5 to-transparent rounded-2xl -rotate-3" />
                
                {/* Main Image Container */}
                <div className="relative w-full h-full bg-linear-to-br from-gray-100 to-gray-200 rounded-2xl overflow-hidden">
                  {/* Professional Image */}
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      fallback.className = 'absolute inset-0 flex items-center justify-center bg-linear-to-br from-gray-100 to-gray-200';
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="shrink-0 p-3 bg-primary/10 rounded-xl group-hover:bg-primary/20 transition-colors duration-300">
