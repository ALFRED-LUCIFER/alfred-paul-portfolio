...
const Testimonials = () => {
  ...
  const TestimonialDialog = ({ testimonialId }: { testimonialId: number }) => {
    ...
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-xs z-50 flex items-center justify-center p-4 md:p-6 lg:p-8">
        <motion.div
          ...
          <div className="p-6 md:p-8 lg:p-10 space-y-6">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                <div className="w-16 h-16 rounded-full bg-linear-to-br from-primary/20 to-primary/5 flex items-center justify-center border-2 border-primary/20 shrink-0">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="relative">
                        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-linear-to-br from-primary/20 to-primary/5 flex items-center justify-center border-2 border-primary/20">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="w-10 h-10 rounded-full bg-linear-to-br from-primary/20 to-primary/5 flex items-center justify-center text-sm font-bold text-primary">
                  {testimonial.name.split(' ').map(n => n[0]).join('')}
                </div>
                <div>
