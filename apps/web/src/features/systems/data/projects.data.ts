...
export const PROJECTS: Project[] = [
  {
    ...
    architectureHighlight:
      'pnpm monorepo — NestJS API + Next.js web + 2 Expo apps sharing one type contract',
    aiImpact:
      'Retell AI outbound calling with usage metering turns lead lists into qualified conversations',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    status: 'internal',
    architectureHighlight:
      'Single-entry delivery engine routing parallel codegen, test, Cypress, and review agents',
    aiImpact:
      'Jira ticket to reviewed, tested code in hours — with human approval and scoring gates',
    caseStudy: {
      problem:
...
async function fullStackFlow(plan: Plan) {
  ...
  },
  {
    ...
    status: 'internal',
    architectureHighlight:
      'Custom MCP server bridging on-prem Jira/Confluence REST APIs to Copilot Studio',
    aiImpact: 'Natural-language ticketing and knowledge-base answers with zero data egress',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    status: 'internal',
    architectureHighlight:
      'Graph-first context: agents resolve where to look before deciding what to read',
  ...
  },
  {
    ...
    status: 'internal',
    architectureHighlight:
      'Layered gates: automated scoring → conformance checks → human sign-off',
  ...
  },
  {
    ...
    status: 'prod',
    architectureHighlight:
      'Next.js 15 catch-all API route dispatching to 12+ typed handler modules',
    aiImpact: 'AI-assisted solo delivery of a production platform — 137+ automated tests in CI',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    status: 'internal',
    architectureHighlight:
      'LangChain RAG pipeline — chunked docs, vector store, grounded answers with citations',
    aiImpact: 'Documentation lookup from hours to minutes across 800+ manuals in two languages',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    aiImpact: 'The delivery foundation AI now builds on — independent deploys, 99.7% uptime',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    aiImpact: 'CI quality gates became the substrate for later agentic review gates',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    aiImpact: 'Anonymous reveal eliminates anchor bias in estimation sessions',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    featured: false,
    status: 'prod',
    architectureHighlight: '7 service verticals with dedicated landing and lead-capture flows',
    aiImpact: 'SEO architecture targeting UAE financial search intent',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    aiImpact: 'Copilot workflows lifted sprint velocity by 40% across 15 engineers',
    caseStudy: {
      problem:
  ...
  },
  {
    ...
    aiImpact: 'Consolidated 4 tools into one — context switching down 70%',
    caseStudy: {
      problem:
